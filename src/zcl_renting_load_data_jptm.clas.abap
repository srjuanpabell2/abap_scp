CLASS zcl_renting_load_data_jptm DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_renting_load_data_jptm IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA: lt_brands    TYPE TABLE OF zrent_brands_jp,
          lt_cars      TYPE TABLE OF zrent_cars_jp,
...
** BRANDS **
    ...
    SELECT * FROM zrent_brands_jp INTO TABLE @lt_brands.
    out->write( sy-dbcnt ).
...
** CARS**
    ...
    INSERT zrent_cars_jp FROM TABLE @lt_cars.
    SELECT * FROM zrent_cars_jp INTO TABLE @lt_cars.
    out->write( sy-dbcnt ).
...
** CUSTOMERS**
    ...
    DELETE FROM zrent_cust_jp.
    INSERT zrent_cust_jp FROM TABLE @lt_customers.
    SELECT * FROM zrent_cust_jp INTO TABLE @lt_customers.
    out->write( sy-dbcnt ).
